...
* insert AddStratifierToGroup(9, 44, Consent.provision.provision.code.coding.where(code='2.16.840.1.113883.3.1937.777.24.5.3.30'\), "consent-rekontaktierung-zusatzbefund-level-1" , "consent-rekontaktierung-zusatzbefund-level-1")
* insert AddStratifierToGroup(9, 45, Consent.provision.provision.code.coding.where(code='2.16.840.1.113883.3.1937.777.24.5.3.31'\), "consent-rekontaktierung-zusatzbefund-level-2" , "consent-rekontaktierung-zusatzbefund-level-2")
