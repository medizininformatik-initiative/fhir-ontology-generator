...
The polymorphic element itself contains no information. Similar to the complex types its information is hold
...
The FHIR spec does only allow Extensions to be used within these constraints,
meaning that these two cases are to only ones we have to handle.
