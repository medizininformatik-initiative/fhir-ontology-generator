...
class TestIdxStructureDefinition:
    @pytest.mark.parametrize(
        ...
        argvalues=[
            pytest.param("https://www.medizininformatik-initiative.de/fhir/core/modul-diagnose/StructureDefinition/Diagnose", "Condition.code.coding", True),
            pytest.param("https://www.medizininformatik-initiative.de/fhir/ext/modul-biobank/StructureDefinition/Specimen", "Specimen.code", False),
            pytest.param("https://www.medizininformatik-initiative.de/fhir/ext/modul-biobank/StructureDefinition/Specimen", "Specimen.type", True),
            pytest.param(
                "https://www.medizininformatik-initiative.de/fhir/ext/modul-biobank/StructureDefinition/Specimen", "Specimen.type.coding", True
            ),
            pytest.param(
                "https://www.medizininformatik-initiative.de/fhir/ext/modul-biobank/StructureDefinition/Specimen", "Specimen.type.coding:sct", True
            ),
            pytest.param(
    ...
    @pytest.mark.parametrize(
        ...
        argvalues=[
            pytest.param("https://www.medizininformatik-initiative.de/fhir/ext/modul-biobank/StructureDefinition/Specimen", "Specimen", True),
            pytest.param(
                "https://www.medizininformatik-initiative.de/fhir/ext/modul-biobank/StructureDefinition/Specimen",
                "Specimen.collection.bodySite.coding",
                True,
