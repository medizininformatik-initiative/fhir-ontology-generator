...
def test_construct_from(elem_def: ElementDefinition, struct_def: IdxStructureDefinition,
    ...
    assert all(isinstance(v, NavElementDefinition) for v in nav_elem_def.children), """
        All child element definitions should be instances of 'NavigableElementDefinition'
    """
    assert all(v.parent and v.parent.id == nav_elem_def.id for v in nav_elem_def.elements), """
            All child element definitions of the element definition should have it as a parent
    """

    assert {v.id for v in nav_elem_def.elements} == elements
    assert {v.id for v in nav_elem_def.slices} == slices
...
def test_element_by_full_id(elem_def: ElementDefinition, full_id: str, expected_id: str | None,
...
def test_slice_by_name(elem_def: ElementDefinition, struct_def: IdxStructureDefinition, name: str, expected_id: str | None):
    nav_elem_def = NavElementDefinition.construct_from(struct_def, elem_def)
...
def test_slice_by_full_id(elem_def: ElementDefinition, full_id: str, expected_id: str | None,
                           struct_def: IdxStructureDefinition):
    nav_elem_def = NavElementDefinition.construct_from(struct_def, elem_def)
...
def test_sub_elem_def_by_full_id(elem_def: ElementDefinition, full_id: str, expected_id: str | None,
                                  struct_def: IdxStructureDefinition):
    nav_elem_def = NavElementDefinition.construct_from(struct_def, elem_def)
...
def test_child_raises_without_arguments(elem_def: ElementDefinition, struct_def: IdxStructureDefinition):
    nav_elem_def = NavElementDefinition.construct_from(struct_def, elem_def)
...
def test_rel_id_property(
    elem_def: ElementDefinition, struct_def: IdxStructureDefinition, expected
):
    nav_elem_def = NavElementDefinition.construct_from(struct_def, elem_def)
