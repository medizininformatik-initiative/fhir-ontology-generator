...
def tmp_project(target_location: Path, template: Optional[Path] = None) -> Project:
    """
    ...
    match request.param:
        ...
        case _ as param:
            raise ValueError(
                ...
                f"{repr(str)}, {repr(IdxStructureDefinition)}, {repr(pathlib.Path)}]]"
            )
...
def nav_struct_def(request, package_manager: FhirPackageManager) -> NavStructureDefinition:
    ...
    match request.param:
        case str(profile_url):
            return NavStructureDefinition.model_validate(**package_manager.find({"url": profile_url}).model_dump())
        ...
        case _ as param:
            raise ValueError(
                ...
                f"[supported_types=[{repr(str)}, {repr(NavStructureDefinition)}]]"
            )
    ...
    match request.param:
        ...
        case _ as param:
            raise ValueError(
                ...
                f"[supported_types=[{repr(str)}, {repr(NavElementDefinition)}]]"
            )
