# Generated from dataportal_generator.common/resources/fhirpath/fhirpath.g4 by ANTLR 4.9.3
# encoding: utf-8
from antlr4 import *
    ...
    def expression(self, _p: int = 0):
        ...
        try:
            ...
            if token in [
                fhirpathParser.T__7,
                fhirpathParser.T__8,
                fhirpathParser.T__10,
                fhirpathParser.T__11,
                fhirpathParser.T__21,
            ...
            while _alt != 2 and _alt != ATN.INVALID_ALT_NUMBER:
                if _alt == 1:
                    ...
                    if la_ == 1:
                        ...
                        _la = self._input.LA(1)
                        if not (
                            _la == fhirpathParser.T__10 or _la == fhirpathParser.T__11
                        ):
                            self._errHandler.recoverInline(self)
                        else:
                            self._errHandler.reportMatch(self)
    ...
    def unit(self):
        ...
        try:
            ...
            if token in [
                ...
                fhirpathParser.T__52,
                fhirpathParser.T__53,
            ]:
                self.enterOuterAlt(localctx, 2)
                self.state = 135
                ...
                (
                    ...
                    and (
                        ...
                        & (
                            ...
                            | (1 << fhirpathParser.T__52)
                            | (1 << fhirpathParser.T__53)
                        )
                    )
                    != 0
                )
