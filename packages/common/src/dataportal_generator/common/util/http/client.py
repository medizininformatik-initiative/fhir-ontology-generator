...
from dataportal_generator.common.util.http.exceptions import (
    raise_appropriate_exception,
)
from dataportal_generator.common.util.http.retries import CustomRetry
from dataportal_generator.common.util.http.url import insert_path_params, format_query_params, merge_urls
...
class BaseClient:
    ...
    def get(
        ...
        path_params: Optional[Mapping[str, str]] = None,
        query_params: Optional[Mapping[str, str | list[str]]] = None,
        stream: bool = False,
