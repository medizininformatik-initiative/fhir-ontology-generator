...
def get_slice_owning_element_id(element_id: str) -> str:
    ...
    """
    return get_parent_slice_id(element_id).rsplit(":",1)[0] if ":" in element_id else element_id
...
def get_slice_name(element_id: str) -> str|None:
    ...
    """
    return get_parent_slice_id(element_id).rsplit(":")[-1] if ":" in element_id else None
