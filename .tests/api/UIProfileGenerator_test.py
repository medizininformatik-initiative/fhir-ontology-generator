...
class UIProfileGeneratorTestCases(unittest.TestCase):
    ...
    def test_translate_element_id_to_fhir_search_parameter(self):
        ...
        mapper.data_set_dir = (
            "../../projects/mii_core_data_set/resources/fdpg_differential"
        )
        mapper.module = (
            "../../projects/mii_core_data_set/resources/fdpg_differential/Bioprobe"
        )
        with open(
            "../../projects/mii_core_data_set/resources/fdpg_differential/Bioprobe/package/"
            "FDPG_Bioprobe-snapshot.json",
            "r",
        ) as f:
            ...
            self.assertEqual(
                [
                    "Specimen.extension.where(url='https://www.medizininformatik-initiative.de/"
                    "fhir/ext/modul-biobank/StructureDefinition/Diagnose').value",
                    "Extension.value as Reference",
