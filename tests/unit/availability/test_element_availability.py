...
from availability.scripts.element_availability import (
    ...
    _generate_stratifiers_for_extension,
...
def test__append_filter_for_slice(
    ...
    value = _append_filter_for_slice(base_expr, slice_elem_def, snapshot, manager)
    assert value == expected
...
def test__generate_stratifiers_for_extension(
    ...
    values = _generate_stratifiers_for_extension(
        ext_snapshot, base_expr, manager, chained_elem_id
    )
        ...
        (
            ...
            [
                MeasureGroupStratifier(
                    ...
                    criteria=Expression(
                        expression="Encounter.extension('http://fhir.de/StructureDefinition/Aufnahmegrund').extension.exists()",
                        language="text/fhirpath",
                    ),
                ),
                MeasureGroupStratifier(
                    ...
                    criteria=Expression(
                        expression="Encounter.extension('http://fhir.de/StructureDefinition/Aufnahmegrund').extension('DritteStelle').exists()",
                        language="text/fhirpath",
                    ),
                ),
                MeasureGroupStratifier(
                    code=CodeableConcept(
                        coding=[
                            Coding(
                                code="Encounter.extension:Aufnahmegrund.extension:DritteStelle.valueCoding",
                                system="http://fhir-data-evaluator/strat/system",
                            )
                        ],
                    ),
                    criteria=Expression(
                        expression="Encounter.extension('http://fhir.de/StructureDefinition/Aufnahmegrund').extension('DritteStelle').value.ofType(Coding).exists()",
                        language="text/fhirpath",
                    ),
                ),
                MeasureGroupStratifier(
                    ...
                    criteria=Expression(
                        expression="Encounter.extension('http://fhir.de/StructureDefinition/Aufnahmegrund').extension('ErsteUndZweiteStelle').exists()",
                        language="text/fhirpath",
                    ),
                ),
                MeasureGroupStratifier(
                    code=CodeableConcept(
                        coding=[
                            Coding(
                                code="Encounter.extension:Aufnahmegrund.extension:ErsteUndZweiteStelle.valueCoding",
                                system="http://fhir-data-evaluator/strat/system",
                            )
                        ],
                    ),
                    criteria=Expression(
                        expression="Encounter.extension('http://fhir.de/StructureDefinition/Aufnahmegrund').extension('ErsteUndZweiteStelle').value.ofType(Coding).exists()",
                        language="text/fhirpath",
                    ),
                ),
                MeasureGroupStratifier(
                    ...
                    criteria=Expression(
                        expression="Encounter.extension('http://fhir.de/StructureDefinition/Aufnahmegrund').extension('VierteStelle').exists()",
                        language="text/fhirpath",
                    ),
                ),
                MeasureGroupStratifier(
                    code=CodeableConcept(
                        coding=[
                            Coding(
                                code="Encounter.extension:Aufnahmegrund.extension:VierteStelle.valueCoding",
                                system="http://fhir-data-evaluator/strat/system",
                            )
                        ],
                    ),
                    criteria=Expression(
                        expression="Encounter.extension('http://fhir.de/StructureDefinition/Aufnahmegrund').extension('VierteStelle').value.ofType(Coding).exists()",
                        language="text/fhirpath",
                    ),
                ),
            ],
        ...
        (
            ...
            [
                MeasureGroupStratifier(
                    criteria=Expression(
                        language="text/fhirpath",
                        expression="Observation.subject.resolve().ofType(Patient).meta.profile.exists($this = 'http://hl7.org/fhir/StructureDefinition/Patient' or $this = 'https://www.medizininformatik-initiative.de/fhir/core/modul-person/StructureDefinition/Patient' or $this = 'https://www.medizininformatik-initiative.de/fhir/core/modul-person/StructureDefinition/PatientPseudonymisiert')",
                    ),
                    code=CodeableConcept(
                        coding=[
                            Coding(
                                system="http://fhir-data-evaluator/strat/system",
                                code="Observation.subject->Patient",
                            )
                        ]
                    ),
                ),
                MeasureGroupStratifier(
                    criteria=Expression(
                        language="text/fhirpath",
                        expression="Observation.subject.resolve().ofType(Group).meta.profile contains 'http://hl7.org/fhir/StructureDefinition/Group'",
                    ),
                    code=CodeableConcept(
                        coding=[
                            Coding(
                                system="http://fhir-data-evaluator/strat/system",
                                code="Observation.subject->Group",
                            )
                        ]
                    ),
                ),
        ...
        (
            ...
            [
                MeasureGroupStratifier(
                    criteria=Expression(
                        language="text/fhirpath",
                        expression="Observation.value.ofType(CodeableConcept).exists()",
                    ),
                    code=CodeableConcept(
                        coding=[
                            Coding(
        ...
        (
            ...
            [
                ...
                MeasureGroupStratifier(
                    criteria=Expression(
                        language="text/fhirpath",
                        expression="Condition.onset.ofType(dateTime).exists()",
                    ),
                    code=CodeableConcept(
                        coding=[
                            Coding(
                ...
                MeasureGroupStratifier(
                    criteria=Expression(
                        language="text/fhirpath",
                        expression="Condition.onset.ofType(Period).exists()",
                    ),
                    code=CodeableConcept(
                        coding=[
                            Coding(
            ...
            MeasureGroup(
                ...
                stratifier=[
                    MeasureGroupStratifier(
                        ...
                        criteria=Expression(
                            language="text/fhirpath",
                            expression="Condition.element1.exists()",
                        ),
                    ),
                    MeasureGroupStratifier(
                        code=CodeableConcept(
                        ...
                        criteria=Expression(
                            language="text/fhirpath",
                            expression="Condition.element1.ofType(string).exists()",
                        ),
                    ),
                    MeasureGroupStratifier(
                        code=CodeableConcept(
                        ...
                        criteria=Expression(
                            language="text/fhirpath",
                            expression="Condition.element1.ofType(boolean).exists()",
                        ),
                    ),
                ],
            ),
...
def test__generate_stratifier_ids(measure: Measure, expected: Measure):
    value = _generate_stratifier_ids(measure)
    assert value.model_dump_json() == expected.model_dump_json()
