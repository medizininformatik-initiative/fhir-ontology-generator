...
class AQLMapEntry:
    ...
    def __init__(self, term_code: TermCode, open_ehr_type: str, term_code_path: str,
                 term_code_path_elements: List[ValuePathElement],
                 value_path: str, value_path_elements: List[ValuePathElement]):
