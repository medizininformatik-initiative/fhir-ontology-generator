...
#### Step 1 - Download and Evaluate FHIR Profile Snapshots
...
- **SearchParameters:** Search parameters are resolved by FHIR path and custom search parameters have to be explicitly 
