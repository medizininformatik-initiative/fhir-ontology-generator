...
After the ontologies have been merged the information has to be converted to be compatible with Elastic Search, which is used to make the 
...
4. Generate the Elastic Search Input files from the merged ontology [link](Elastic-README.md)
5. Parcel the ontology files [link to documentation](##generate-cohort)
...
- **Term Code Info:** Contains additional information for each termcode in the ui trees
