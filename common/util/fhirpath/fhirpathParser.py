...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write("\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3")
        buf.write("\7\3P\n\3\f\3\16\3S\13\3\3\4\3\4\3\4\3\4\3\4\3\4\3\4\5")
        buf.write("\4\\\n\4\3\5\3\5\3\5\3\5\3\5\3\5\3\5\3\5\3\5\3\5\5\5h")
        buf.write("\n\5\3\6\3\6\3\6\5\6m\n\6\3\7\3\7\3\7\3\7\3\7\5\7t\n\7")
        buf.write("\3\b\3\b\3\b\5\by\n\b\3\b\3\b\3\t\3\t\3\t\7\t\u0080\n")
        buf.write("\t\f\t\16\t\u0083\13\t\3\n\3\n\5\n\u0087\n\n\3\13\3\13")
        ...
        buf.write("R\5\3\2\2\2SQ\3\2\2\2T\\\5\f\7\2U\\\5\b\5\2V\\\5\n\6\2")
        buf.write("WX\7\36\2\2XY\5\4\3\2YZ\7\37\2\2Z\\\3\2\2\2[T\3\2\2\2")
        buf.write("[U\3\2\2\2[V\3\2\2\2[W\3\2\2\2\\\7\3\2\2\2]^\7 \2\2^h")
        buf.write("\7!\2\2_h\t\n\2\2`h\7>\2\2ah\7?\2\2bh\7@\2\2ch\79\2\2")
        buf.write("dh\7:\2\2eh\7;\2\2fh\5\22\n\2g]\3\2\2\2g_\3\2\2\2g`\3")
        buf.write("\2\2\2ga\3\2\2\2gb\3\2\2\2gc\3\2\2\2gd\3\2\2\2ge\3\2\2")
        buf.write("\2gf\3\2\2\2h\t\3\2\2\2il\7$\2\2jm\5\36\20\2km\7>\2\2")
        buf.write("lj\3\2\2\2lk\3\2\2\2m\13\3\2\2\2nt\5\36\20\2ot\5\16\b")
        buf.write("\2pt\7%\2\2qt\7&\2\2rt\7\'\2\2sn\3\2\2\2so\3\2\2\2sp\3")
        buf.write("\2\2\2sq\3\2\2\2sr\3\2\2\2t\r\3\2\2\2uv\5\36\20\2vx\7")
        buf.write("\36\2\2wy\5\20\t\2xw\3\2\2\2xy\3\2\2\2yz\3\2\2\2z{\7\37")
        buf.write("\2\2{\17\3\2\2\2|\u0081\5\4\3\2}~\7(\2\2~\u0080\5\4\3")
        buf.write("\2\177}\3\2\2\2\u0080\u0083\3\2\2\2\u0081\177\3\2\2\2")
        buf.write("\u0081\u0082\3\2\2\2\u0082\21\3\2\2\2\u0083\u0081\3\2")
        buf.write("\2\2\u0084\u0086\7?\2\2\u0085\u0087\5\24\13\2\u0086\u0085")
        buf.write("\3\2\2\2\u0086\u0087\3\2\2\2\u0087\23\3\2\2\2\u0088\u008c")
        buf.write("\5\26\f\2\u0089\u008c\5\30\r\2\u008a\u008c\7>\2\2\u008b")
        buf.write("\u0088\3\2\2\2\u008b\u0089\3\2\2\2\u008b\u008a\3\2\2\2")
        buf.write("\u008c\25\3\2\2\2\u008d\u008e\t\13\2\2\u008e\27\3\2\2")
        buf.write("\2\u008f\u0090\t\f\2\2\u0090\31\3\2\2\2\u0091\u0092\5")
        buf.write("\34\17\2\u0092\33\3\2\2\2\u0093\u0098\5\36\20\2\u0094")
        buf.write("\u0095\7\3\2\2\u0095\u0097\5\36\20\2\u0096\u0094\3\2\2")
        buf.write("\2\u0097\u009a\3\2\2\2\u0098\u0096\3\2\2\2\u0098\u0099")
        buf.write("\3\2\2\2\u0099\35\3\2\2\2\u009a\u0098\3\2\2\2\u009b\u009c")
        buf.write("\t\r\2\2\u009c\37\3\2\2\2\16\'OQ[glsx\u0081\u0086\u008b")
        buf.write("\u0098")
        return buf.getvalue()
...
class fhirpathParser ( Parser ):
    ...
    def expression(self, _p:int=0):
        ...
        try:
            ...
            if token in [fhirpathParser.T__10, fhirpathParser.T__11, fhirpathParser.T__21, fhirpathParser.T__22, fhirpathParser.T__27, fhirpathParser.T__29, fhirpathParser.T__31, fhirpathParser.T__32, fhirpathParser.T__33, fhirpathParser.T__34, fhirpathParser.T__35, fhirpathParser.T__36, fhirpathParser.DATE, fhirpathParser.DATETIME, fhirpathParser.TIME, fhirpathParser.IDENTIFIER, fhirpathParser.DELIMITEDIDENTIFIER, fhirpathParser.STRING, fhirpathParser.NUMBER, fhirpathParser.LONGNUMBER]:
                ...
                self.term()
                pass
            elif token in [fhirpathParser.T__3, fhirpathParser.T__4]:
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        ...
                        self.state = 49
                        _la = self._input.LA(1)
                        if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << fhirpathParser.T__13) | (1 << fhirpathParser.T__14) | (1 << fhirpathParser.T__15) | (1 << fhirpathParser.T__16))) != 0)):
                            self._errHandler.recoverInline(self)
                        else:
                            self._errHandler.reportMatch(self)
                            self.consume()
                        ...
                        self.state = 75
                        _la = self._input.LA(1)
                        if not(_la==fhirpathParser.T__10 or _la==fhirpathParser.T__11):
                            self._errHandler.recoverInline(self)
                        else:
                            self._errHandler.reportMatch(self)
                            self.consume()
    ...
    def term(self):
        ...
        try:
            ...
            if token in [fhirpathParser.T__10, fhirpathParser.T__11, fhirpathParser.T__21, fhirpathParser.T__22, fhirpathParser.T__34, fhirpathParser.T__35, fhirpathParser.T__36, fhirpathParser.IDENTIFIER, fhirpathParser.DELIMITEDIDENTIFIER]:
                ...
                self.invocation()
                pass
            elif token in [fhirpathParser.T__29, fhirpathParser.T__31, fhirpathParser.T__32, fhirpathParser.DATE, fhirpathParser.DATETIME, fhirpathParser.TIME, fhirpathParser.STRING, fhirpathParser.NUMBER, fhirpathParser.LONGNUMBER]:
                localctx = fhirpathParser.LiteralTermContext(self, localctx)
                self.enterOuterAlt(localctx, 2)
                self.state = 83
                self.literal()
                pass
            elif token in [fhirpathParser.T__33]:
                localctx = fhirpathParser.ExternalConstantTermContext(self, localctx)
                self.enterOuterAlt(localctx, 3)
                self.state = 84
                self.externalConstant()
                pass
            elif token in [fhirpathParser.T__27]:
    ...
    def literal(self):
        ...
        try:
            ...
            if la_ == 1:
                ...
                localctx = fhirpathParser.LongNumberLiteralContext(self, localctx)
                self.enterOuterAlt(localctx, 5)
                self.state = 96
                self.match(fhirpathParser.LONGNUMBER)
                pass
    ...
    def externalConstant(self):
        ...
        try:
            ...
            if token in [fhirpathParser.T__10, fhirpathParser.T__11, fhirpathParser.T__21, fhirpathParser.T__22, fhirpathParser.IDENTIFIER, fhirpathParser.DELIMITEDIDENTIFIER]:
                ...
                self.identifier()
                pass
            elif token in [fhirpathParser.STRING]:
                self.state = 105
                self.match(fhirpathParser.STRING)
                pass
            else:
    ...
    def unit(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [fhirpathParser.T__38, fhirpathParser.T__39, fhirpathParser.T__40, fhirpathParser.T__41, fhirpathParser.T__42, fhirpathParser.T__43, fhirpathParser.T__44, fhirpathParser.T__45]:
                self.enterOuterAlt(localctx, 1)
                self.state = 134
                self.dateTimePrecision()
                pass
            elif token in [fhirpathParser.T__46, fhirpathParser.T__47, fhirpathParser.T__48, fhirpathParser.T__49, fhirpathParser.T__50, fhirpathParser.T__51, fhirpathParser.T__52, fhirpathParser.T__53]:
                self.enterOuterAlt(localctx, 2)
                self.state = 135
    ...
    def dateTimePrecision(self):
        ...
        try:
            ...
            self.state = 139
            _la = self._input.LA(1)
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << fhirpathParser.T__38) | (1 << fhirpathParser.T__39) | (1 << fhirpathParser.T__40) | (1 << fhirpathParser.T__41) | (1 << fhirpathParser.T__42) | (1 << fhirpathParser.T__43) | (1 << fhirpathParser.T__44) | (1 << fhirpathParser.T__45))) != 0)):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
    ...
    def pluralDateTimePrecision(self):
        ...
        try:
            ...
            self.state = 141
            _la = self._input.LA(1)
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << fhirpathParser.T__46) | (1 << fhirpathParser.T__47) | (1 << fhirpathParser.T__48) | (1 << fhirpathParser.T__49) | (1 << fhirpathParser.T__50) | (1 << fhirpathParser.T__51) | (1 << fhirpathParser.T__52) | (1 << fhirpathParser.T__53))) != 0)):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
